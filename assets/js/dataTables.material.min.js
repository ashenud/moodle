...
(function (a) {
    ...
    d.ext.renderer.pageButton.material = function (b, l, w, x, m, r) {
        var k = new d.Api(b),
            ...
            u = function (c, d) {
                ...
                for (e = d.length; q < e; q++) {
                    ...
                    if (a.isArray(f)) u(c, f);
                        ...
                        p && (h += " mdl-button--raised mdl-button--colored");
                        g && (p = a("<button>", {
                            "class": "mdl-button " + h,
                            id: 0 === w && "string" ===
                            ...
                            disabled: -1 !== h.indexOf("disabled")
                        }).html(g).appendTo(c), b.oApi._fnBindAction(p, {
                            action: f
                        }, l), t++)
                    }
                }
        ...
        u(a(l).empty().html('<div class="pagination"/>').children(), x);
        v !== e && a(l).find("[data-dt-idx=" + v + "]").focus()
    };
    return d
});