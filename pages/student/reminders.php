                                                    ...
                                                    <?php
                                                        if( mysqli_num_rows($reminder_list) > 0 ) {
                                                            while ($rem = mysqli_fetch_object($reminder_list)) {
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <span class="discription"><?php echo $rem->reminder?></span>
                                                                    </td>
                                                                    <td style="text-align: center;">
                                                                        <span class="date pull-right"><?php echo $rem->date?></span>
                                                                    </td>
                                                                    <td style="text-align: center;">
                                                                        <button class='btn' id='del_rem_btn' onclick="delete_reminder(<?php echo $rem->id?>)">
